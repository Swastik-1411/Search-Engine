...
filename = 'Hackathon1/Qdata/index.txt'
...
with open('Hackathon1/tf-idf/vocab.txt', 'w') as f:
    for key in vocab.keys():
        f.write("%s\n" % key)

# save the idf values in a text file
with open('Hackathon1/tf-idf/idf-values.txt', 'w') as f:
    for key in vocab.keys():
        f.write("%s\n" % vocab[key])

# save the documents in a text file
with open('Hackathon1/tf-idf/documents.txt', 'w') as f:
...
with open('Hackathon1/tf-idf/inverted-index.txt', 'w') as f:
